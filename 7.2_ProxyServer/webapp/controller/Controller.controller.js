sap.ui.define([
	...
	return Controller.extend("sap.ui.table.sample.TreeTable.HierarchyMaintenanceJSONTreeBinding.controller.Controller", {
		onInit: function() {
			var oModel = new JSONModel("./model/Clothing.json");

			this.getView().setModel(oModel);
			this._aClipboardData = [];
			const oDatamodel = new ODataModel("northWind/v2/northwind/northwind.svc/");
